...
import { employeeSidebar, InventorySidebar, SalesSidebar } from './constant/constant';
  ...
  return (
    <BrowserRouter>
      <Router>
        ...
        <Route path='employee' element={<ProjectLayout layout={employeeSidebar}/>}>
        ...
        <Route path='inventory' element={<ProjectLayout layout={InventorySidebar}/>}>
